...
enum class BottomnavigationItem(val icon:Int,val navDestination :DestinationScreen){
    CHATLIST(R.drawable.whatsapp,DestinationScreen.ChatList),
    STATUSLIST(R.drawable.sattus,DestinationScreen.StatusList),
    PROFILE(R.drawable.male,DestinationScreen.Profile)
}
